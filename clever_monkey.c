/* an improvement on thread_monkey.c with a 
better algorithm to reduce the number of loops
needed
*/ 
...
int main() 
{
    ...
    printf("\rThis gives a total %llu combinations and some very fat monkeys\n",counter ); 
